...
document.addEventListener('DOMContentLoaded', function () {
    ...
    setTimeout(() => {
        ...
        const phone = document.querySelector('.header__phone') as HTMLElement | null;
        if (phone) {
        ...
        // ===== АНИМАЦИЯ ГЕРОЯ =====
        const heroTitle = document.querySelector('.hero__title') as HTMLElement | null;
        if (heroTitle) {
        ...
        const heroSubtitle = document.querySelector('.hero__subtitle') as HTMLElement | null;
        if (heroSubtitle) {
        ...
        const heroQuote = document.querySelector('.hero__quote') as HTMLElement | null;
        if (heroQuote) {
        ...
        const heroButtons = document.querySelector('.hero__buttons') as HTMLElement | null;
        if (heroButtons) {
        ...
        const aboutContent = document.querySelector('.about__content') as HTMLElement | null;
        const factCards = document.querySelectorAll('.fact-card');
        const aboutElements: HTMLElement[] = [];

        if (aboutContent) aboutElements.push(aboutContent);
        factCards.forEach((card) => aboutElements.push(card as HTMLElement));
