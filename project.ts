...
class ProjectsModule {
  ...
  private animateHeader(): void {
    ...
    const navLinks = document.querySelectorAll<HTMLElement>(
      '.nav__list .nav__link, .nav__list .nav__item--dropdown'
    );
    navLinks.forEach((link, index) => {
      link.style.opacity = '0';
      link.style.transform = 'translateY(-20px)';
      const delay: number = 150 + (index * 80);
      setTimeout(() => {
    ...
    const phone = document.querySelector('.header__phone') as HTMLElement;
    if (phone) {
  ...
  private animateProjectsHero(): void {
    const hero = document.querySelector('.projects-hero') as HTMLElement;
    if (hero) {
  ...
  private animateStats(): void {
    const stats = document.querySelector('.projects-stats') as HTMLElement;
    if (stats) {
  ...
  private animateGridHeader(): void {
    const header = document.querySelector('.projects-grid__header') as HTMLElement;
    if (header) {
  ...
  private animateCarouselControls(): void {
    const controls = document.querySelector('.carousel-controls-wrapper') as HTMLElement;
    if (controls) {
    ...
    const projects: Project[] = [
      {
        ...
        category: 'Интерьер',
        images: [
          'dizayn-i-remont-doma-v-kp-lesnaya-polyana-v-stile-sovremennyy-1-etazh-kukhnya-gostinaya-foto-20.png',
          'zagorodniy.dom_03.png',
          'images.png'
        ],
      ...
      },
      {
        ...
        category: 'Интерьер',
        images: [
          'https://via.placeholder.com/600x400/A8A098/1A1513?text=Неоклассика+1',
          'https://via.placeholder.com/600x400/989088/1A1513?text=Неоклассика+2',
          'https://via.placeholder.com/600x400/888078/1A1513?text=Неоклассика+3'
        ],
      ...
      },
      {
        ...
        category: 'Интерьер',
        images: [
          'https://via.placeholder.com/600x400/888078/1A1513?text=Минимализм+1',
          'https://via.placeholder.com/600x400/787068/1A1513?text=Минимализм+2',
          'https://via.placeholder.com/600x400/686058/1A1513?text=Минимализм+3'
        ],
      ...
      },
      {
        ...
        images: [
          'https://via.placeholder.com/600x400/585048/1A1513?text=Арт-деко+1',
          'https://via.placeholder.com/600x400/484038/1A1513?text=Арт-деко+2',
          'https://via.placeholder.com/600x400/383028/1A1513?text=Арт-деко+3'
        ],
  ...
  private closeProjectModal = (modalOverlay: HTMLElement): void => {
  ...
  // =========================================================
  private initGalleries(): void {
    document.querySelectorAll<HTMLElement>('.project-card__gallery').forEach(gallery => {
      const track = gallery.querySelector<HTMLElement>('.project-card__gallery-track');
      const slides = gallery.querySelectorAll<HTMLElement>('.project-card__gallery-slide');
