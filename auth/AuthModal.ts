...
class AuthModal {
    ...
    private codeTimer: number | null = null;
    private codeSeconds: number = 0;
    private isCodeSent: boolean = false;

    // DOM элементы
    private formLogin: HTMLFormElement | null = null;
    private formRegister: HTMLFormElement | null = null;
    private tabLogin: HTMLElement | null = null;
    private tabRegister: HTMLElement | null = null;
    private submitBtn: HTMLButtonElement | null = null;
    private submitRegisterBtn: HTMLButtonElement | null = null;
    private closeBtn: HTMLElement | null = null;
    private switchToRegister: HTMLElement | null = null;
    private switchToLogin: HTMLElement | null = null;
    private title: HTMLElement | null = null;
    private subtitle: HTMLElement | null = null;
    private sendCodeBtn: HTMLButtonElement | null = null;
    private codeField: HTMLElement | null = null;
    private codeInput: HTMLInputElement | null = null;
    private codeHint: HTMLElement | null = null;

    // Статическое меню пользователя
    private static userMenu: HTMLElement | null = null;
    ...
    private createModal(): void {
        ...
        this.formLogin = document.getElementById('authFormLogin') as HTMLFormElement;
        this.formRegister = document.getElementById('authFormRegister') as HTMLFormElement;
        ...
        this.submitRegisterBtn = document.getElementById('authRegSubmit') as HTMLButtonElement;
        ...
        this.sendCodeBtn = document.getElementById('authSendCode') as HTMLButtonElement;
        this.codeField = document.getElementById('authCodeField');
        this.codeInput = document.getElementById('authRegCode') as HTMLInputElement;
    ...
    private switchMode(mode: AuthMode): void {
        ...
        if (mode === 'login') {
            ...
            if (this.title) this.title.textContent = 'Вход в кабинет';
            if (this.subtitle) this.subtitle.textContent = 'Войдите, чтобы управлять заказами и избранным';
        } else {
            ...
            if (this.title) this.title.textContent = 'Создать аккаунт';
            if (this.subtitle) this.subtitle.textContent = 'Зарегистрируйтесь, чтобы получить доступ ко всем возможностям';
            this.resetCodeState();
        }
    ...
    private async handleLogin(e: Event): Promise<void> {
        ...
        const remember = (document.getElementById('authRemember') as HTMLInputElement)?.checked || false;
    ...
    private async handleRegister(e: Event): Promise<void> {
        ...
        const password = (document.getElementById('authRegPassword') as HTMLInputElement)?.value || '';
        const code = (document.getElementById('authRegCode') as HTMLInputElement)?.value || '';
        const agree = (document.getElementById('authRegAgree') as HTMLInputElement)?.checked || false;
